...
- Output modes: "content" shows matching lines, "filesWithMatches" shows only file paths (default), "count" shows match counts
...
- Results are sorted by modification time when using filesWithMatches mode
